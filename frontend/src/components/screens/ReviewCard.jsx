...
const ReviewCard = ({ review }) => {
  ...
  return (
    <>
      <motion.div className="rounded-md bg-white duration-300 transition-all ease-in-out p-6 w-max max-w-96 cursor-pointer shadow-2xl shadow-[#EFF7FF] relative overflow-hidden">
